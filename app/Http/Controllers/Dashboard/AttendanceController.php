            ...
            ->addColumn(
                ...
                function ($dataDb) {
                    if ($dataDb->attendance_detail[0]->status == 0) {
                        ...
                        return '<button class="btn btn-md text-center" data-bs-toggle="tooltip" id="editBtn" data-id="' . $dataDb->attendance_detail[0]->id . '" data-name="' . $dataDb->user->name . '" type="button" data-bs-placement="bottom" title="Edit"><i class="fa-sharp fa-solid fa-pen-to-square fa-md" style="color: #6893df;"></i></button>';
                    } else {
                        ...
                        <button class="btn btn-md text-center" data-bs-toggle="tooltip" id="editBtn" data-id="' . $dataDb->attendance_detail[0]->id . '" data-name="' . $dataDb->user->name . '" type="button" data-bs-placement="bottom" title="Edit"><i class="fa-sharp fa-solid fa-pen-to-square fa-md" style="color: #6893df;"></i></button>';
                    }
                }
            )
            ...
            ->addColumn(
                ...
                function ($dataDb) {
                    if ($dataDb->status == 0) {
                        ...
                        return '<button class="btn btn-md text-center" data-bs-toggle="tooltip" id="editBtn" data-id="' . $dataDb->id . '" data-name="' . $dataDb->user->name . '" type="button" data-bs-placement="bottom" title="Edit"><i class="fa-sharp fa-solid fa-pen-to-square fa-md" style="color: #6893df;"></i></button>';
                    } else {
                        ...
                        <button class="btn btn-md text-center" data-bs-toggle="tooltip" id="editBtn" data-id="' . $dataDb->id . '" data-name="' . $dataDb->user->name . '" type="button" data-bs-placement="bottom" title="Edit"><i class="fa-sharp fa-solid fa-pen-to-square fa-md" style="color: #6893df;"></i></button>';
                    }
                }
            )
            ->filter(function ($instance) use ($request) {
