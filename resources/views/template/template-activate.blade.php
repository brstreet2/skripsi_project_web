                    ...
                    <tr>
                      <td style="font-size:0px;padding:15px;text-align:left">
                        <div>
                          ...
                          <p class="contenttext-text-block contenttextstyle-scope" align="center" style="color:rgb(52,52,52);font-family:'Plus Jakarta Sans',sans-serif;;font-size:28px;font-weight:bolder;padding:0px;margin:13px 0px;line-height:1.6">Verifikasi Email kamu</p>
                          <p class="contenttext-text-block contenttextstyle-scope" align="center" style="color:rgb(52,52,52);font-family:'Plus Jakarta Sans',sans-serif;;font-size:18px;padding:0px;margin:13px 0px;line-height:1.6">Tekan tombol dibawah untuk melakukan verifikasi email</p>
            ...
            <td style="text-align:center;vertical-align:top;font-size:0px">
              <div class="boxcolumn boxcolumn-100" style="display:inline-block;width:100%;vertical-align:top">
                <table width="100%" cellspacing="0" cellpadding="0" border="0">
                  <tbody>
                    <tr>
                      <td style="font-size:0px;padding:15px;text-align:center" class="contentalignmentContainer">
                        <div style="margin-left:auto;margin-right:auto">
                          <p style="font-family:'Plus Jakarta Sans',sans-serif;;padding:0px;margin:13px 0px 0px;line-height:1.6;color:rgb(153,153,153);font-size:11px">AEHR azka ernest erick HR.. sabiiii</p>
                        </div>
                      </td>
                    </tr>
                  </tbody>
