                                        ...
                                        <td style="font-size:0px;padding:15px;text-align:left">
                                            <div>
                                                ...
                                                <p class="contenttext-text-block contenttextstyle-scope" align="center"
                                                    ...
                                                    Tekan tombol dibawah untuk melakukan mengganti password anda</p>
                                                <p align="center"
                                                    ...
                                                    <a href="{{ route('auth.set.password', [$code]) }}"
                                                        style="display:inline-block;background-color:#444eff;border-radius:32px;color:#fff;font-family:'Plus Jakarta Sans',sans-serif;;font-weight:700;letter-spacing:1px;margin:0;padding:12px 56px;text-decoration:none"><span
                                                            class="il">Ganti</span> Password</a>
                                                </p>
                                                <p class="contenttext-text-block contenttextstyle-scope" align="center"
                                                    ...
                                                    Anda dapat merubah password akun Anda dengan menyalin dan
                                                    menempelkan
                                                    URL di bawah ini ke browser Anda:</p>
                                                <p class="contenttext-text-block contenttextstyle-scope" align="center"
                                                    style="color:rgb(52,52,52);font-family:'Plus Jakarta Sans',sans-serif;;font-size:15px;padding:0px;margin:13px 0px;line-height:1.6">
                                                    <a
                                                        href="{{ route('auth.set.password', [$code]) }}">{{ route('auth.set.password', [$code]) }}</a>
                                                </p>
                                                <p class="contenttext-text-block contenttextstyle-scope" align="center"
