                    ...
                    <div class="col">
                        <div class="card px-4 py-3 border-0" style="border-radius: 1rem">
                            ...
                            <div class="row g-0 mt-3">
                                ...
                                <div class="col-10">
                                    <form method="POST" action="{{ route('auth.set.password.post', [$token]) }}">
                                        {{ csrf_field() }}
                                        ...
                                        <div class="form-group mb-3">
                                            <div class="input-group flex-nowrap">
                                                <input type="password"
                                                    ...
                                                    name="repassword" id="inputPassword2"
                                                    placeholder="Pastikan Password Sama" style="border-radius: .75rem"
                                                    required>
                                            </div>
                                        </div>
                                        @error('repassword')
