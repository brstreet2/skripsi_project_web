                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center font-mp">
                                ...
                                <button class="btn btn-danger fw-bolder mb-4 px-4 rounded-pill" href="">Decline</button>
                                <button class="btn btn-primary fw-bolder mb-4 px-4 rounded-pill" href="" style="background-color: #444EFF" >Approve</button>
                                </a>
                           </td>  
                        </tr>
                    </tbody>
