            ...
            <nav class="nav">
                <div> <a href="#" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">SKRIPSI</span> </a>
                    <div class="nav_list"> 
                        ...
                        <a href="{{ route('pricing.index') }}" class="nav_link {{ request()->route()->named('pricing.*')? 'active': '' }}"> <i class='bx bx-dollar-circle nav_icon'></i> <span class="nav_name">Pricing</span> </a> 
                    </div>
                </div> 
