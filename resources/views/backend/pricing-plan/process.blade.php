    ...
    <div class="row mb-4">
        ...
        <div class="card" style="border-radius: .75rem; border: none; background-color: #fcfcfc;">
            <div class="card-body text-center"  onload="_cntDown=setInterval('ShowTimes()',1000)">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-10 text-start">
                                        ...
                                        <h5 id="copyAcc">Rp.999.999 <button type="button" class="btn btn-sm border border-primary" onclick="copyContent()"
                                            style="border-radius: 7px"><span
                                            class="fa-regular fa-clipboard fa-lg" style="color: #444EFF"></span></button> </h5>
                ...
                <button class="btn btn-primary" onclick="start()" style="background-color: #444EFF; border-radius: 10px">Konfirmasi Pembayaran</button>
            </div>
        </div>
    </div>
    </div>
