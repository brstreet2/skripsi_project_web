                ...
                <div class="col-3">
                    <div class="form-group has-danger">
                        ...
                        <input type="text" class="form-control mb-2" name="document_name" required id="document_name"
                            placeholder="Masukkan Nama Dokumen" style="border-radius: .5rem" value="{{ old('document_name', $documentDb->name) }}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control mb-2" name="description" required id="description" placeholder="Deskripsi Isi Dokumen" style="height: 20rem; border-radius: .5rem">{!! old('description', htmlentities($documentDb->description)) !!}</textarea>
                    </div>
                </div>
                <div class="col">
                    <div class="form-group">
                    ...
                    <div class="text-end mt-3">
                        ...
                        <button class="btn rounded-pill text-center btn-primary px-5 py-2 fw-bolder" type="submit" style="background-color: #444EFF">Save</button>
                    </div>
                </div>
            </div>
        </div>
